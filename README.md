...
- **🧭 Ручной вход через браузер** - изолированные браузерные профили на каждый аккаунт, автозаливка cookies, выбор прокси и расширений
...
### 🧭 **Browser Launcher (ручной вход)**

- **🌐 Запуск браузера на аккаунт**: изолированный Chromium-профиль, автозаливка cookies из storage, возврат в меню после закрытия окна
- **🌍 Выбор прокси**: прокси аккаунта / direct / свой, режим cs.deals напрямую
- **🧩 Выбор расширения**: unpacked-расширения из `browser_extensions/` на каждый запуск
- **🔒 Защита от повторного запуска**: session lock и маркер `[*]` открытых аккаунтов
