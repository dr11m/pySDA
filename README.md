...
**🕐 Временные интервалы:**
- Интервал проверки трейдов (рекомендуется 60-120 секунд)
- Интервал проверки сессии (рекомендуется 300-600 секунд)

**🎁 Автоматическое принятие:**
- Принимать подарки (когда вам дают предметы бесплатно)
- Принимать трейды от друзей
- Принимать трейды с определенными тегами
