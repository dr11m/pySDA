...
from .models import Currency, GameOptions, SteamUrl
from .utils import (
...
class SteamMarket:
    def __init__(self, session: Session, steam_id: str) -> None:
    ...
    def _set_login_executed(self, steamguard: dict, session_id: str) -> None:
        ...
        self.con_executor = ConfirmationExecutor(
            steamguard['identity_secret'], self._steam_id, self._session,
        )
